/* Generated By:JavaCC: Do not edit this line. Grammar5.java */
...
import compilerDesign.hw5.jasmin.JasminMaker;
import compilerDesign.hw5.scope.BigScope;
import compilerDesign.hw5.scope.Entry;
import compilerDesign.hw5.scope.Entry.Type;

@SuppressWarnings("all")
public class Grammar5 implements Grammar5Constants {
        ...
        /* the SYMBOL TABLE MWAHAHA */
        static BigScope symbolTable = new BigScope();

        /* Javer ASSembly thingy */
        static JasminMaker jasmin = new JasminMaker();
	 ...
	 */
        ...
        public static void emitJasmin(String outPath)
        throws IOException
        {
                if(jasmin != null)
                        jasmin.writeToFile(outPath);
        }
        ...
        throws ParseException, IOException
        {
                ...
                Grammar5 parser = new Grammar5(stream);
  ...
  static final public void Input() throws ParseException {
    ...
    Statement();
    jj_consume_token(0);
                // close the symbol table's current scope
  ...
  static final public String Statement() throws ParseException {
    ...
    case CharLiteral:
      ...
      jj_consume_token(Semicolon);
                ...
                Entry e = symbolTable.getEntryById(s1);
                ...
                if(!symbolTable.isEntryInScope(e))
                        {if (true) throw new ParseException(
                                        "Visibility: '" + s1 + "' is not visible in the current " +
                                        "scope " +
                                        "(at line " + now.beginLine + ", column " +
                                        now.beginColumn + ")");}
                ...
                if(!validAssignment)
                        {if (true) throw new ParseException(
                                        ...
                                        e.getType() + ", but the value being assigned is of " +
                                        "type " + t +
                                        " (at line " + now.beginLine + ", column " +
                                        now.beginColumn + ")");}
                ...
                int scopeId = symbolTable.getScopeId(s1);

                jasmin.stopExpression(s1, scopeId);
  ...
  static final public String Expression() throws ParseException {
    ...
    case CharLiteral:
      s = Id();
                ...
                Entry e = symbolTable.getEntryById(s);
                ...
                if(!symbolTable.isEntryInScope(e))
                        {if (true) throw new ParseException(
                                        "Visibility: '" + s + "' is not visible in the current " +
                                        "scope " +
                                        "(at line " + now.beginLine + ", column " +
                                        now.beginColumn + ")");}
  ...
  static final public String VarDecl() throws ParseException {
    ...
    s1 = Type();
    s2 = Id();
                Entry e = symbolTable.getEntryById(s2);
                ...
                int scopeId = symbolTable.getScopeId(s2);

                jasmin.addDeclaration(s2, scopeId);
  ...
  static final public String Id() throws ParseException {
    ...
    t = jj_consume_token(CharLiteral);
                int scopeId = symbolTable.getScopeId(t.image);

                if(scopeId == -1)
                        scopeId = symbolTable.getCurrentScopeId();

                String uid = JasminMaker.getUniqueId(t.image, scopeId);
  ...
  static public Grammar5TokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x24e0,0x24e0,0x20180,0x200,0x60,};
   }

  public Grammar5(java.io.InputStream stream) {
     this(stream, null);
  }
  public Grammar5(java.io.InputStream stream, String encoding) {
    ...
    token_source = new Grammar5TokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public Grammar5(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser.  You must");
      System.out.println("       either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public Grammar5(Grammar5TokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser.  You must");
      System.out.println("       either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public void ReInit(Grammar5TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
