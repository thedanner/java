...
public class RedBlackTest<AnyType> extends JFrame
implements ActionListener {
	...
	public void showAll() {
		RBTreeIterator<AnyType> itr = tree.iterator( );
		while (itr.hasNext( ))  {
			theDisplay.append("\n" + itr.next( ));
		}
		theDisplay.append("\n\n");
	...
	public RedBlackTest(RedBlackTree<AnyType> tree)  {
		this.tree = tree;
		...
		setTitle("RED-BLACK TREE TEST MENU");
		setSize(600, 400);
	...
	public static void main(String[ ] args)  {
		RedBlackTree<String> rbt = new RedBlackTree<String>(new StringComparator ( ));
		new RedBlackTest<String>(rbt);
	}
}
